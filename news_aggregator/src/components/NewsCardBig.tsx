...
export default function NewsCardBig({
  ...
  return (
    <div>
      <div className="flex flex-col font-roboto sm:w-[250px] md:w-[280px] lg:w-[320px] sm:h-[280px] md:h-[320px] lg:h-[360px] border-2 border-none bg-background_light rounded-t-md mb-0">
      ...
      <div className="flex flex-row border-2 border-t-0 border-none bg-secondary rounded-b-md sm:h-[25px] md:h-[30px] lg:h-[35px]">
